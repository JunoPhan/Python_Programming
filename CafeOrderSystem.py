...
def summarize_order(order):
    ...
    for i in order:                  #order is list of sub dictionary from menu - i is dictionary
        for key in i.keys():         #iterate through list of keys in dict - name and price key
            if(key=="name"):         #if key matches key name, save value to names list 
             name.append(i[key])

    names = tuple(name)   #convert list to tuple- immutable
